             ...
             <div class="row">
               <div class="col-xs-12 col-sm-3 center">
                 <span class="profile-picture">
                   <img src="{{asset('storage/'.$user->photo)}}" class="img-rounded" alt="Cinque Terre" style="padding-left: 10px;" width="300" height="200">
                 </span>

                 <div class="space space-4"></div>

                 <a href="{{url('users/'.$user->id.'/modifier')}}" class="btn btn-sm btn-block btn-success">
               ...
               <div class="col-xs-12 col-sm-9">
                 ...
                 <div class="profile-user-info">
                   ...
                   <div class="profile-info-row">
                     <div class="profile-info-name"> Ncin </div>
