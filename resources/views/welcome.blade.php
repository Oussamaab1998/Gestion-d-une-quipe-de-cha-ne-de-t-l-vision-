...
<link rel="stylesheet" href="css/tooplate-style.css">
        ...
        <style>
            html, body {
                ...
                height: 100vh;
                margin: 0;
                background-image: url('public\assets\img\desk.jpeg');
            }
        ...
        <div class=" text-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                        <a class="btn btn-danger" style="color:white" class="text" href="{{ url('/login') }}">Login</a>
                          ...
                          <div class="row">
                               ...
                               <div class="col-md-offset-5 col-md-7 col-sm-12">
                                    <div class="home-thumb">
                                         <h1 class="wow fadeInUp" data-wow-delay="0.4s">Hello, I am Nihel.</h1>
                          ...
                          <div class="row">
                               ...
                               <div class="col-md-4 col-sm-8">
                                    <div class="about-image-thumb">
                                         ...
                                         <img src="{{asset('images/p1.jpg')}}" class="wow fadeInUp img-responsive" data-wow-delay="0.2s" alt="about image">
                               ...
                               <div class="wow fadeInUp col-md-4 col-sm-6" data-wow-delay="0.4s">
                                    ...
                                    <div class="work-thumb">
                                         <a href="images/p3.jpg" class="image-popup">
                                              ...
                                              <img src="images/p4.jpg" class="img-responsive" alt="Work 2">
                                         </a>
                                    </div>
                               </div>
